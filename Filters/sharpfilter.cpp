...
const int SharpFilter::kernel[SharpFilter::KERNEL_SIZE_X][SharpFilter::KERNEL_SIZE_Y] =
                                      {{ 0, -1,  0},
                                       {-1,  5, -1},
                                       { 0, -1,  0}};

SharpFilter::SharpFilter(QObject *parent) : Filter(parent)
{

}

void SharpFilter::checkColor( float &color )
{
     if ( color > 255 )
     {
        color = 255;
...
void SharpFilter::apply( RawImage *inputImage )
{
